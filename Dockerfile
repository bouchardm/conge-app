...
RUN apt-get update && apt-get -y upgrade && apt-get -y install apache2 php7.0 php7.0-mysql libapache2-mod-php7.0 curl lynx-cur php-xml acl mysql-server
...
# start database # service mysql start
